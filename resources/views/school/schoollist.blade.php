    						...
    						<table class="table datatable_Userlist checklist_table" id="school_table" style="width:100%;">
    							<thead>
    								<tr>
    									...
    									<th style="width: 30%; text-align: center;" >School Name</th>
    							...
    							<tbody>
    								...
    								<tr>
    									<th scope="row">{{$item->SchoolUID}}</th>
    									<td style=" text-align: center;" >{{$item->School_Name}}</td>
    									<td style=" text-align: center;" >
    										@if($item->Active == 1)
    										<button type="button" style="height: 1.5rem;width: 75px;" class="btn btn-sm btn-soft-success">Active</button>
    										@else
    										<button type="button" style="height: 1.5rem;width: 75px;" class="btn btn-sm btn-soft-danger">In-active</button>
    										@endif
    									</td>
    									<td>
    										<div class="dropdown">
    											...
    											<div class="dropdown-menu dropdown-new-menu dropdown-menu-end myloans-custom-action-menu">
    												<a href="{{route('edit-school',base64_encode($item->SchoolUID))}}" class="dropdown-item">
